...
We starten met een die eenvoudig kan bijgesteld worden om uiteiendelijk te komen tot een  geautomatiseerde workflow.
...
De external_id uit het meemoo-archiefsysteem biedt een hoge mate van zekerheid op vlak van uniciteit en persistentie met voldoende granulariteit, namelijk tot op digitaal object. Om zonder omweg de identifier te kunnen gebruiken in de image endpoitn zal deze toegepast worden in de naamgeving van de afgeleide beeldbestanden:{identifier}.{ext}, vb.wp9t14vr7s_19140404_0001.jp2.
