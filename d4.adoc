...
. https://www.google.com/url?q=https://iiif.io/api/image/&sa=D&source=editors&ust=1619601270737000&usg=AOvVaw1O0zPDRjbCQbOvAHyUvCF4[Image API] voor het aanbieden in al dan niet bewerkte vorm (rotatie, zoom, fragment, kleuraanpassing, formaat) van bestanden en de technische metadata (info.json)
. https://www.google.com/url?q=https://iiif.io/api/presentation/&sa=D&source=editors&ust=1619601270738000&usg=AOvVaw3HLsrbupHmj_RZg2kG6OfE[Presentation API] voor de beschrijving in json-formaat (manifests) van de structuur en/of layout van een object, een collectie van objecten of gerelateerde objecten
. https://www.google.com/url?q=https://iiif.io/api/search/&sa=D&source=editors&ust=1619601270738000&usg=AOvVaw1Kv8vHP2hLd7CAEDyUkQpK[Content Search API] voor het doorzoeken van transcripties (OCR), vertalingen, annotaties van een via IIIF aangeboden bron
. https://www.google.com/url?q=https://iiif.io/api/auth/&sa=D&source=editors&ust=1619601270739000&usg=AOvVaw02uj_E6P-rdVaeVkZP62Kd[Authentication API] voor het afschermen van de bronnen voor niet geauthenticeerd gebruik (bearer token)

Er zijn nog API's in ontwikkeling:

. https://www.google.com/url?q=https://iiif.io/api/discovery/0.9/&sa=D&source=editors&ust=1619601270739000&usg=AOvVaw1say0fInbSrograClfSWLt[Change Discovery API] die het machines eenvoudiger maken om IIIF-bronnen te vinden, bv. voor de ontwikkeling van (thematische) zoekmachines en portaalapplicaties
. https://www.google.com/url?q=https://iiif.io/api/content-state/0.3/&sa=D&source=editors&ust=1619601270740000&usg=AOvVaw3sKp9lgIEtZG9tw-eEkkRZ[Content State API] waarmee (een deel) van de inhoud van een IIIF Presentation API bron doorgegeven kan worden aan applicaties, ongeacht hun verschillende gebruikersinterfaces en mogelijkheden
...
In het voorjaar van 2019 zette meemoo samen met de VKC, https://www.google.com/url?q=http://artinflanders.be/&sa=D&source=editors&ust=1619601270761000&usg=AOvVaw15eBHPRTWgizKbdunzor7g[artinflanders.be] en andere beeldpartners de eerste stappen naar een vlotte, effici├½nte en geautomatiseerde ontsluiting van beeldmateriaal in de tweede fase van dit project. Daarbij houden we rekening met de (technische) aanbevelingen (de zogenaamde modelarchitectuur) uit de https://www.google.com/url?q=https://www.projectcest.be/wiki/Projecten:Blauwdruk_Gedistribueerd_Beeldbeheer&sa=D&source=editors&ust=1619601270761000&usg=AOvVaw12BOysqJqKGrDHI1iLSH7X[Blauwdruk gedistribueerd beeldbeheer] die we eerder opstelden.
...
* Als ingestcomponent is gekozen voor https://www.google.com/url?q=https://www.resourcespace.com/&sa=D&source=editors&ust=1619601270762000&usg=AOvVaw38kdneEypoAsyxCirX-BNV[ResourceSpace], een software die al door een aantal partners van VKC gebruikt wordt voor de ontsluiting van hun beelden. ResourceSpace is een DAM-systeem (beeldbeheersysteem) waarmee de beelden opgenomen kunnen worden in de proefopstellingen en waarin vervolgens de metadata uit de Datahub gekoppeld kunnen worden aan de beelden.
* Als IIIF-beeldenserver kozen we https://www.google.com/url?q=https://cantaloupe-project.github.io/&sa=D&source=editors&ust=1619601270762000&usg=AOvVaw02m21oJHlqZ_mbjaY_YjEj[Cantaloupe], omwille van de mogelijkheid om de metadata die ingebed wordt in de beelden te behouden in de kopie├½n van de afgeleiden. Via Cantaloupe zullen de beelden uitwisselbaar zijn via de IIIF Image API.
* Er werd een https://www.google.com/url?q=http://imagehub.vlaamsekunstcollectie.be/&sa=D&source=editors&ust=1619601270763000&usg=AOvVaw0dS8Uxeq6BjwaI5XnvB2xn[Imagehub] ontwikkeld om de beelden en hun metadata via de IIIF Presentation API te ontsluiten (via IIIF-manifests). Deze webapplicatie wordt gemaakt in hetzelfde framework waarmee de Datahub ontwikkeld werd (PHP/Symfony).
* De IIIF-manifests zelf zullen getoond worden in de https://www.google.com/url?q=https://universalviewer.io/&sa=D&source=editors&ust=1619601270763000&usg=AOvVaw1QYGjldmmtoU01nQEwHvX1[Universal Viewer]. Dit is een beeldenviewer die IIIF-manifests kan weergeven.

Samen vormden deze componenten de IIIF-proefopstelling. Testen gebeurde met tweehonderd beelden uit de collecties van de partnermusea van de VKC. De aangepaste versie van de Arthub ontsluit nu beelden via de Universal Viewer door een koppeling met de https://www.google.com/url?q=http://imagehub.vlaamsekunstcollectie.be/&sa=D&source=editors&ust=1619601270764000&usg=AOvVaw23xs2e50JkcMfcMY2u5cF_[Imagehub].
...
Detailpagina op website NVDGO: https://www.google.com/url?q=https://nieuwsvandegrooteoorlog.hetarchief.be/nl/media//l1MefUOcXVhxmdUiFta43bZl&sa=D&source=editors&ust=1619601270765000&usg=AOvVaw3MgyhvYZJN4gl-kDmtuY1a[L'ind├®pendance belge | Nieuws van de Groote Oorlog (hetarchief.be)]

Voor de website https://www.google.com/url?q=https://nieuwsvandegrooteoorlog.hetarchief.be/&sa=D&source=editors&ust=1619601270766000&usg=AOvVaw1-SdUKm-MWtnwbJ6xzMRd_[Nieuws van de Groote Oorlog] (NVDGO) heeft meemoo (destijds VIAA) een IIPImage server, of ipsrv, opgezet voor de ontsluiting van multipage kranten en andere documenten via een OpenLayers3 canvas-viewer op de site. Als protocol wordt in de viewer Zoomify gebruikt, maar ook IIP en IIIF zijn ondersteund.

Voor meer info en documentatie zie:

* https://www.google.com/url?q=https://meemoo.atlassian.net/wiki/spaces/HAP/pages/111902756/IIPImage%2Ben%2BIIIF&sa=D&source=editors&ust=1619601270767000&usg=AOvVaw3wB-PGwFIHxAei7sd_Pu8P[IIPImage en IIIF - Het Archief (Publiek) - meemoo documentation (atlassian.net)]
* https://www.google.com/url?q=https://meemoo.atlassian.net/wiki/spaces/TB/pages/1855684732/Handleiding%2BIIIF-beelden%2Bgebruiken&sa=D&source=editors&ust=1619601270767000&usg=AOvVaw2DqXW24LifoNOhh7AoNOI4[Handleiding IIIF-beelden gebruiken - Interactie - meemoo documentation (atlassian.net)]

Deze image server is oorspronkelijk opgezet als dedicated endpoint voor de NVDGO website. Om ook uitwisseling met derden mogelijk en eenvoudiger te maken is op basis van een initi├½le vraag van de "Boekentoren" (UGent) een aantal aanpassingen doorgevoerd:

* De URL werd herschreven zonder querystring (?IIIF=&#x2026;) naar https://www.google.com/url?q=http://iiif.viaa.be/&sa=D&source=editors&ust=1619601270768000&usg=AOvVaw0IbXp-2-zMGkNaJnjS_NSA[iiif.viaa.be] (nu https://www.google.com/url?q=http://meemoo.be/&sa=D&source=editors&ust=1619601270768000&usg=AOvVaw1IqpqwPGUgRSeyH3N4-cFI[meemoo.be])
...
Hiervoor werd een Python script geschreven dat via nginx-specifieke X-Accel-Redirect headers de request doorstuurt naar de relevante URL op https://www.google.com/url?q=http://images.hetarchief.be/&sa=D&source=editors&ust=1619601270769000&usg=AOvVaw0v3yzLRwKB2iL5HplFjm0G[http://images.hetarchief.be]. Zie: https://www.google.com/url?q=https://github.com/viaacode/iiif-mapping&sa=D&source=editors&ust=1619601270770000&usg=AOvVaw0xk-k1q2XMTbGFLJQdyPcT[https://github.com/viaacode/iiif-mapping] .

====== Image information request

https://www.google.com/url?q=https://images.hetarchief.be/iipsrv/?IIIF%3D/media/5/S/S2aTZOTWggiebVVpZpSTJPWd/wp9t14vr7s_19140404_0001/info.json&sa=D&source=editors&ust=1619601270770000&usg=AOvVaw0BJ80odREo10pxn0S9vq4J[https://images.hetarchief.be/iipsrv/?IIIF=/media/5/S/S2aTZOTWggiebVVpZpSTJPWd/wp9t14vr7s_19140404_0001/info.json]
...
* https://www.google.com/url?q=https://images.hetarchief.be/iipsrv/?IIIF%3D/media/5/S/S2aTZOTWggiebVVpZpSTJPWd/wp9t14vr7s_19140404_0001/full/full/0/default.jpg&sa=D&source=editors&ust=1619601270775000&usg=AOvVaw12Hm9TqkDzdvZBRYnQlMtM[https://images.hetarchief.be/iipsrv/?IIIF=/media/5/S/S2aTZOTWggiebVVpZpSTJPWd/wp9t14vr7s_19140404_0001/full/full/0/default.jpg]
* https://www.google.com/url?q=https://iiif.meemoo.be/wp9t14vr7s_19140404_0001/full/full/0/default.jpg&sa=D&source=editors&ust=1619601270775000&usg=AOvVaw0eMF_td-xK9c277XQw3aJ6[https://iiif.meemoo.be/wp9t14vr7s_19140404_0001/full/full/0/default.jpg]

Hoewel via beide routes de request wordt afgehandeld door dezelfde image server wijkt de info.json via de https://www.google.com/url?q=http://iif.meemoo.be/&sa=D&source=editors&ust=1619601270776000&usg=AOvVaw1oC5IcfgvFWw749r0gC-kK[iif.meemoo.be] route af door de toevoeging van een rights-attribuut onderin de json (https://www.google.com/url?q=https://github.com/viaacode/iiif-mapping/commit/58da7b0b6a7355a955cd313c5f54f76de654af90&sa=D&source=editors&ust=1619601270776000&usg=AOvVaw2Pt7bi27D2i-7CGAmqAU9S[https://github.com/viaacode/iiif-mapping/commit/58da7b0b6a7355a955cd313c5f54f76de654af90])
...
* We streven een level 2 compliance na, echter indien level 1 voldoende functionaliteit biedt voor VKC kan hiermee worden volstaan (https://www.google.com/url?q=https://iiif.io/api/image/3.0/compliance&sa=D&source=editors&ust=1619601270781000&usg=AOvVaw3QB3ufPDnqaQtwji7ogInA[https://iiif.io/api/image/3.0/compliance])
...
https://www.google.com/url?q=https://jpeg.org/jpeg2000/&sa=D&source=editors&ust=1619601270796000&usg=AOvVaw216r8kllL1E-su_iGlJNWe[JPEG - JPEG 2000]
...
https://www.google.com/url?q=https://www.loc.gov/preservation/digital/formats/fdd/fdd000022.shtml&sa=D&source=editors&ust=1619601270797000&usg=AOvVaw2GU-oUUW10qgAP7pKAuBub[TIFF, Revision 6.0 (loc.gov)]

A tag-based file format for storing and interchanging raster images. TIFF serves as a wrapper for different bitstream encodings for bit-mapped (raster) images. The different encodings may represent different compression schemes and different schemes for color representation (photometric interpretation).
...
Binnen het Archiefsysteem (MAM) van meemoo heeft elke intellectuele entiteit (IE) een persistent identif├«er of pid, vb.: wp9t14vr7s (krant). Pids worden toegekend aan het begin en gebruikt doorheen de hele keten van registratie, digitalisering, archivering tot ontsluiting. Elk media-object van een IE heeft ook een external_id die bestaat uit de pid en bij meervoudige objecten een bijkomende classifier, vb.: wp9t14vr7s_19140404_0001 (pagina 1 van krant).
...
https://www.google.com/url?q=https://images.hetarchief.be/iiif/wp9t14vr7s_19140101_0001/info.json&sa=D&source=editors&ust=1619601270800000&usg=AOvVaw2Z3ILjBKl6dCpEWUY-t5as[https://images.hetarchief.be/iiif/wp9t14vr7s_19140101_0001/info.json]

Het is niet de bedoeling een bijkomende resolver te gebruiken om een image request te mappen van een local (VKC) identifier naar een external_id (meemoo) identifier. Om in https://www.google.com/url?q=https://arthub.vlaamsekunstcollectie.be/nl/iiif/2/kmska:494/manifest.json&sa=D&source=editors&ust=1619601270801000&usg=AOvVaw14nI86-lFH4rPGPZNnU8oC[de presentation manifests van de VKC-Arthub] de correcte @id voor een beeld weer te geven zal in de database van de VKC de op https://www.google.com/url?q=https://arthub.vlaamsekunstcollectie.be/nl/catalog/kmska:494&sa=D&source=editors&ust=1619601270801000&usg=AOvVaw3brx91biUMHc6MdlBzuYMC[cataloognummer] (kmska:494) gemapte meemoo-identifier bij VKC bijgehouden moeten worden. In het kader van dit project levert meemoo hiervoor de nodige data met de metadata-export waarbij wordt onderzocht of en hoe die structureel kan worden uitgewisseld (vb. via de MediaHaven Rest API).
...
In onderstaande tabel wordt de gewenste opbouw van de info.json weergegeven. Dit zou moeten volstaan binnen de scope van dit project en verder. Let wel, https://www.google.com/url?q=https://iiif.io/api/image/2.1/%23image-information&sa=D&source=editors&ust=1619601270802000&usg=AOvVaw3hoGBw9iB0s2i8s9aUROgA[dit is voor versie 2.1 van de Image API], meer informatie over de info.json in versie 3.0 is terug te vinden op: https://www.google.com/url?q=https://iiif.io/api/image/3.0/%235-image-information&sa=D&source=editors&ust=1619601270803000&usg=AOvVaw2bHdMonqp9bnF0hqas4fG_[https://iiif.io/api/image/3.0/#5-image-information]

[cols=",,",]
|===
|Property |Compliance |Omschrijving
|@context |Required |The context document that describes the semantics of the terms used in the document. This must be the URI: http://iiif.io/api/image/2/context.jsonfor version 2.1 of the IIIF Image API. This document allows the response to be interpreted as RDF, using the https://www.google.com/url?q=http://www.json-ld.org/&sa=D&source=editors&ust=1619601270806000&usg=AOvVaw2PR7NIJms82v-4Ruu7kFkd[JSON-LD]serialization.
|@id |Required |The base URI of the image as defined in https://www.google.com/url?q=https://iiif.io/api/image/2.1/%23uri-syntax&sa=D&source=editors&ust=1619601270808000&usg=AOvVaw3Vhye_GiUrVyb4cazQQLvP[URI Syntax], including scheme, server, prefix and identifier without a trailing slash.
...
|profile |Required |A list of profiles, indicated by either a URI or an object describing the features supported. The first entry in the list _must_be a https://www.google.com/url?q=https://iiif.io/api/image/2.1/%23compliance-levels&sa=D&source=editors&ust=1619601270815000&usg=AOvVaw1HC1jF6PjE4KFLvXdzKNni[compliance level URI]. Zie https://www.google.com/url?q=https://iiif.io/api/image/2.1/%23profile-description&sa=D&source=editors&ust=1619601270816000&usg=AOvVaw0pwwh0BY7qSK5-u5pMJlNu[https://iiif.io/api/image/2.1/#profile-description]voor de properties.
|attribution |Optional |Text that _must_be shown when content obtained from the Image API service is displayed or used. It might include copyright or ownership statements, or a simple acknowledgement of the providing institution. The value _may_contain simple HTML as described in the https://www.google.com/url?q=https://iiif.io/api/presentation/3.0/%23html-markup-in-property-values&sa=D&source=editors&ust=1619601270817000&usg=AOvVaw0yJtyUqZjL6waBva_CN2qx[HTML Markup in Property Values]section of the Presentation API.
...
|logo |Optional |A small image that represents an individual or organization associated with the content. Logo images _must_be clearly rendered when content obtained from the Image API service is displayed or used. Clients _must not_crop, rotate, or otherwise distort the image.
|===
...
* https://www.google.com/url?q=https://meemoo.atlassian.net/wiki/spaces/SF/pages/1172930633/Syncrator&sa=D&source=editors&ust=1619601270827000&usg=AOvVaw3qT2sy0jgSwXSys33J3gBL[Syncrator]: taakgebaseerde ETL-service die de synchronisatie van metadata uit het MAM (de bron) naar de lokale datastore (het doel) verzorgt
...
* https://www.google.com/url?q=https://gitlab.com/shared-components/indexer&sa=D&source=editors&ust=1619601270827000&usg=AOvVaw19Ayb9rs3HbFpmVL6stJl4[Indexer]: een ETL service die de synchronisatie tussen database en index regelt op basis van database triggers en webhooks
* ElasticSearch als standaard index die de zoekfunctionaliteit in de platformen mogelijk maakt
* https://www.google.com/url?q=https://meemoo.atlassian.net/wiki/spaces/SF/pages/1373274138&sa=D&source=editors&ust=1619601270828000&usg=AOvVaw0AnkdEHd0f91LBz6i3_8NG[Hasura GraphQL] voor naadloos gebruik bovenop een postgresql database. Dit vormt de basis-API waarmee de frontendapplicaties met de datastore kunnen connecteren.
* https://www.google.com/url?q=https://meemoo.atlassian.net/wiki/spaces/SF/pages/1546977330&sa=D&source=editors&ust=1619601270829000&usg=AOvVaw3OKwpxn092h5gIuiU0FDH2[IDM]: een volledige Identity en Access Management stack:
...
* Storage is eveneens goedkoper en makkelijk uitbreidbaar in DCO (zie ÔÇÿOpslag')
...
De toepassing logt via stdoutnaar een ELK-stack (Elasticsearch-Logstash-Kibana). Kort samengevat moeten de log messages voldoen aan de volgende voorwaarden:
...
Zie voor meer informatie de https://www.google.com/url?q=https://meemoo.atlassian.net/wiki/spaces/SF/pages/1177387132/Dev%2Bguidelines%2Blogging&sa=D&source=editors&ust=1619601270842000&usg=AOvVaw27xqUouhRodjbZPkZ76bOM[logging guidelines voor developers].
...
Alle applicaties bij meemoo worden beschreven en gedocumenteerd op de Confluence wiki van meemoo in de _Software Factory._Daarnaast bevat elke code repository een README. Handleidingen en developer documentatie worden afhankelijk van de mate van openbaarheid bewaard op de vermelde wiki of indien nuttig ontsloten via https://www.google.com/url?q=https://developer.meemoo.be/&sa=D&source=editors&ust=1619601270844000&usg=AOvVaw1Bu14fifhbBt_hjQbqZrjn[https://developer.meemoo.be].
...
Requests verstuurd naar https://www.google.com/url?q=https://images.meemoo.be/&sa=D&source=editors&ust=1619601270847000&usg=AOvVaw2urtVDoy-IGx0vKqY8DsXw[https://images.meemoo.be] worden opgevangen op de nginx proxy-server van meemoo. De Proxy routeert het verkeer op basis van het path naar de gewenste onderliggende applicatie of onderliggende functie en geeft de respectievelijke responses terug aan de "requester". Indien nodig worden tijdens dit proces URL's vertaald en herschreven.

Daarnaast fungeert de proxy ook als https://www.google.com/url?q=https://docs.nginx.com/nginx/admin-guide/content-cache/content-caching/%23processes&sa=D&source=editors&ust=1619601270847000&usg=AOvVaw0s_lQCwucXyUCSGAnStsWW[content cache] voor de image server. Dit gebeurt bijvoorbeeld voor de jpeg-afbeeldingen die door image server van NVDGO worden aangemaakt. De disk cache van de proxy is een aanvulling op de memcached cache van de image server.
...
* Ondersteuning voor Image API 2.1 https://www.google.com/url?q=https://github.com/ruven/iipsrv/issues/177&sa=D&source=editors&ust=1619601270852000&usg=AOvVaw2a4YbtKIuKhAsr7P3JdJ2i[en sinds kort ook 3.0] (zie onder)
...
Voor meer opties en configuratiemogelijkheden zie: https://www.google.com/url?q=https://iipimage.sourceforge.io/documentation/server/&sa=D&source=editors&ust=1619601270855000&usg=AOvVaw3SUDcE9EC6FJAc_gdB9LA-[https://iipimage.sourceforge.io/documentation/server/]
...
https://www.google.com/url?q=https://images.meemoo.be/download/%257Bidentifier:external_id%257D/%257Bformat:jp2%257Ctiff%257Cpng&sa=D&source=editors&ust=1619601270856000&usg=AOvVaw1pTil0VxO9rWzEOFPL0g05[https://images.meemoo.be/download/\{identifier:external_id}/\{format:jp2|tiff|png]}
...
TODO Inschatting + planning (Gantt).

=== WIP Conclusie

TODO Te schrijven bij finaliseren deliverable.

'''''

Created by Bart Debunne, last modified on 30 mrt. 2021
